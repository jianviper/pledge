<template>
  <div>
    ...
    <el-table :data="ZFTableData.slice((currentPage - 1) * pageSize, currentPage * pageSize)"
              border
              stripe
    ...
    <!--    添加资方数据窗口-->
    <el-dialog title="添加资方" :visible.sync="dialogVisible" width="500px" :show-close="false"
  ...
  export default {
    ...
    methods: {
      search() {
        ...
        this.$axios.post('baseInfo/agency/buyBackList', {
          name: this.name,
      ...
      editRow(index, rowData) {
        ...
        this.agencyFormData = JSON.parse(JSON.stringify(rowData));
        this.dialogVisible = true;
      },
      statusChange(value) {
